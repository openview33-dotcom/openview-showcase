...
const platforms = [
  { name: "Instagram", discSize: 110, iconSize: 44, top: "28%", left: "8%", bg: "linear-gradient(135deg, #833AB4, #E4405F, #FCAF45)", svg: (<svg width="44" height="44" viewBox="0 0 24 24" fill="white"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>) },
  { name: "Google Ads", discSize: 100, iconSize: 40, top: "5%", left: "55%", bg: "#ffffff", svg: (<svg width="40" height="40" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/></svg>) },
  { name: "Meta", discSize: 90, iconSize: 36, top: "42%", left: "42%", bg: "#0668E1", svg: (<svg width="36" height="22" viewBox="0 0 100 60" fill="white"><path d="M15.6 5C9.4 5 4.8 11.2 2.4 17.6.8 22 0 27 0 30.6c0 7.2 3 14.4 9.4 14.4 3.6 0 6.2-2.2 9.4-7.4l5.6-9.2 5.6 9.2c3.2 5.2 5.8 7.4 9.4 7.4 6.4 0 9.4-7.2 9.4-14.4 0-3.6-.8-8.6-2.4-13C44.2 11.2 39.6 5 33.4 5c-4.8 0-8 3-11.8 8.6L16.4 22l-5.2-8.4C7.4 8 4.6 5 15.6 5zm0 7c2.4 0 4.6 2.4 7.2 6.8L28 27.4l-5.2 8.4c-3.2 5.2-5 6.6-7.4 6.6-3.4 0-5.8-4.8-5.8-11.8 0-3.2.6-7.2 1.8-10.6C13 15.4 14 12 15.6 12zm17.8 0c1.6 0 2.6 3.4 4.2 8 1.2 3.4 1.8 7.4 1.8 10.6 0 7-2.4 11.8-5.8 11.8-2.4 0-4.2-1.4-7.4-6.6L21 27.4l5.2-8.6C29.4 14.4 31 12 33.4 12z"/></svg>) },
  { name: "YouTube", discSize: 72, iconSize: 28, top: "68%", left: "18%", bg: "#FF0000", svg: (<svg width="28" height="20" viewBox="0 0 24 17"><path d="M23.495 2.91A3.01 3.01 0 0021.38.78C19.505.25 12 .25 12 .25S4.495.25 2.62.78A3.01 3.01 0 00.505 2.91 31.6 31.6 0 000 8.5a31.6 31.6 0 00.505 5.59 3.01 3.01 0 002.115 2.13C4.495 16.75 12 16.75 12 16.75s7.505 0 9.38-.53a3.01 3.01 0 002.115-2.13A31.6 31.6 0 0024 8.5a31.6 31.6 0 00-.505-5.59zM9.545 12.02V4.98L15.818 8.5l-6.273 3.52z" fill="white"/></svg>) },
  { name: "LinkedIn", discSize: 65, iconSize: 26, top: "10%", left: "22%", bg: "#0A66C2", svg: (<svg width="26" height="26" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" fill="white"/></svg>) },
  { name: "TikTok", discSize: 58, iconSize: 22, top: "62%", left: "72%", bg: "#010101", svg: (<svg width="22" height="22" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V9.17a8.16 8.16 0 004.77 1.52V7.25a4.85 4.85 0 01-1-.56z" fill="white"/></svg>) },
];
